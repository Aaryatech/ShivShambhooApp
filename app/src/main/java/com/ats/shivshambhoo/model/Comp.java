...
public class Comp {
    ...
    @SerializedName("compLoc")
    @Expose
    private String compLoc;
    @SerializedName("compOfficeAdd")
    @Expose
    private String compOfficeAdd;
    @SerializedName("compFactAdd")
    @Expose
    private String compFactAdd;
    @SerializedName("compOtherAdd")
    @Expose
    private String compOtherAdd;
    @SerializedName("compLicence")
    @Expose
    ...
    public String toString() {
        return "Comp{" +
                ...
                ", compName='" + compName + '\'' +
                ", compLoc='" + compLoc + '\'' +
                ", compOfficeAdd='" + compOfficeAdd + '\'' +
                ", compFactAdd='" + compFactAdd + '\'' +
                ", compOtherAdd='" + compOtherAdd + '\'' +
                ", compLicence='" + compLicence + '\'' +
                ", compPanNo='" + compPanNo + '\'' +
                ", compGstNo='" + compGstNo + '\'' +
