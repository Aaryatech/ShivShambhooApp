...
public class AddProjectModel {
    ...
    public AddProjectModel(int projId, String projName, int custId, String location, String startDate, String endDate, int isUsed, int delStatus, String contactPerMob, String contactPerName, String pincode, float km, String address) {
        this.projId = projId;
