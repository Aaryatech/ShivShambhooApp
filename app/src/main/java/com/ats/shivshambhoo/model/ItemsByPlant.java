...
public class ItemsByPlant {
    ...
    public int getUomNewId() {
        return uomNewId;
    }

    public void setUomNewId(int uomNewId) {
        this.uomNewId = uomNewId;
    }
    ...
    public String toString() {
        return "ItemsByPlant{" +
                ...
                ", maxStock=" + maxStock +
                ", rolStock=" + rolStock +
                ", plantMinStock=" + plantMinStock +
                ", plantMaxStock=" + plantMaxStock +
                ", plantRolStock=" + plantRolStock +
                ", vendorIds='" + vendorIds + '\'' +
                ", delStatus=" + delStatus +
                ", exInt1=" + exInt1 +
                ", exInt2=" + exInt2 +
