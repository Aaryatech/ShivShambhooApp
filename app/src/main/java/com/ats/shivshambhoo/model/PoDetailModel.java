...
//    }
    ...
    public PoDetailModel(int poDetailId, int poId, int itemId, float poRate, float poQty, float poConsumeQty, float poRemainingQty, int status, String remark, float taxAmt, float taxPer, float taxableAmt, float otherCharges, float total, int quDetailId, String varchar1, String varchar2, int extra1, int extra2) {
