...
public class QuotationHeaderForPdf {
    ...
    public List<GetQuotDetail> getGetQuotDetailList() {
        return getQuotDetailList;
    }

    public void setGetQuotDetailList(List<GetQuotDetail> getQuotDetailList) {
        this.getQuotDetailList = getQuotDetailList;
    }

    @Override
    public String toString() {
        return "QuotationHeaderForPdf{" +
