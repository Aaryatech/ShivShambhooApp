...
public class QuotationHeader {
    ...
    public QuotationHeader(int quotHeadId, String quotNo, int custId, int userId, String quotDate, int enqHeadId, int companyId, int plantIds, int status, int delStatus, float quotTaxableAmt, float quotTaxAmt, float quotTotal, int payTermId, int transportTermId, String payTerms, String transportTerms, String otherRemark1,String otherRemark2,String otherRemark3,String otherRemark4,int projId, int noOfTolls, float tollCost, float otherCost, float transportCost, float quotValue, float taxValue, float taxableValue, int quotTermId, float noOfKm, List<QuotDetail> quotDetailList) {
    ...
    public String toString() {
        return "QuotationHeader{" +
                ...
                ", status=" + status +
                ", delStatus=" + delStatus +
                ", quotTaxableAmt=" + quotTaxableAmt +
                ", quotTaxAmt=" + quotTaxAmt +
                ", quotTotal=" + quotTotal +
                ", payTermId=" + payTermId +
                ", transportTermId=" + transportTermId +
                ", payTerms='" + payTerms + '\'' +
                ", transportTerms='" + transportTerms + '\'' +
                ", otherRemark1='" + otherRemark1 + '\'' +
                ", otherRemark2='" + otherRemark2 + '\'' +
                ", otherRemark3='" + otherRemark3 + '\'' +
                ", otherRemark4='" + otherRemark4 + '\'' +
                ", otherValueBeforeTax1=" + otherValueBeforeTax1 +
                ", otherValueBeforeTax2=" + otherValueBeforeTax2 +
                ", otherValueAfterTax1=" + otherValueAfterTax1 +
                ", otherValueAfterTax2=" + otherValueAfterTax2 +
                ", projId=" + projId +
                ", noOfTolls=" + noOfTolls +
                ", tollCost=" + tollCost +
                ", otherCost=" + otherCost +
