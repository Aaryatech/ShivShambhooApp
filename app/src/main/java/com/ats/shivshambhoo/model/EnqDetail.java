...
public class EnqDetail {
    ...
    public EnqDetail(int enqDetailId, int enqHeadId, int itemId, float itemQty, String itemUom, int itemUomId, int status, int delStatus, int quotId, int enqUomId, String enqDRemark) {
